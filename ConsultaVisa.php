<html>
<head>
	<title>Consultas con pago con tarjeta Visa</title>
</head>
<style>
*{
...
<Body>
<h1><center>Pagos con tarjeta Visa</h1>
<font color="#FFFFFF">
<?php
	include("Conexion.php");
	
	$result=mysql_query("select * from datos_personales where forma_pago='Visa'",$link);
?>
