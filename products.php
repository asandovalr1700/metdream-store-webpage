...
// --- Consulta SQL ---
$sql = "SELECT nombre_prod, precio, imagen_url, descripcion FROM playera";
...
<body>
  ...
  if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {echo "<div class='producto'>";
...
function comprarProducto(nombre) {
  alert("Has hecho clic en COMPRAR el producto: " + nombre);
  // Simulación temporal:
  window.location.href = "checkout.php?producto=" + encodeURIComponent(nombre);
}

function agregarCarrito(nombre) {
  alert("Producto añadido al carrito: " + nombre);
  // En el futuro: enviar petición AJAX o guardar en sessionStorage
}
</script>
