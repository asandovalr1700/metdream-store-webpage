<html>
<head>
	<title>Consultas con pago con PayPal</title>
</head>
<style>
*{
...
<Body>
<h1><center>Pagos con PayPal</h1>
<font color="#FFFFFF">
<?php
	include("Conexion.php");
	
	$result=mysql_query("select * from datos_personales where forma_pago='PayPal'",$link);
?>
<table border width="100%" cellpadding="7px" align="center" class="content">
		<tr><td><b>Numero de cuenta:</b></td>
        <td><b>Nombre:</b></td>
        <td><b>Apellidos:</b></td>
        <td><b>E-mail:</b></td>
        <td><b>Dirección:</b></td>
